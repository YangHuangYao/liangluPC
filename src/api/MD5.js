  ...
  let MD5= function (prefix) {
    ...
    var convertToWordArray = function (value) {
      var lWordCount;
    ...
    var uTF8Encode = function (value) {
      value = value.replace(/\x0d\x0a/g, "\x0a");
      value = prefix + value;
      var output = "";
